...
export default function GalleryGridSection() {
  const images = [
    { src: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=800&q=80", alt: "أجواء الغناء العربي الكلاسيكي", title: "أجواء حفلاتها" },
    { src: "https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=800&q=80", alt: "موسيقى عربية تقليدية", title: "التراث الموسيقي" },
    { src: "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?auto=format&fit=crop&w=800&q=80", alt: "آلات موسيقية عربية", title: "الآلات الموسيقية" },
    { src: "https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?auto=format&fit=crop&w=800&q=80", alt: "مسرح كلاسيكي", title: "المسرح العربي" },
    { src: "https://images.unsplash.com/photo-1507838153414-b4b713384a76?auto=format&fit=crop&w=800&q=80", alt: "موسيقى عربية", title: "الإرث الفني" },
    { src: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80", alt: "صوت ونغم", title: "صوت يتجاوز الزمن" },
  ]
